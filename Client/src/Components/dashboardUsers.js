  ...
  <DataTable
    columns={[
      ...
      },
      {
        ...
        field: "userVerified",
        render: (rowData) => (
          <p className={`px-2 py-1 w-32 text-center text-primary rounded-md ${rowData.userVerified ? "bg-emerald-500" : "bg-red-500"}`}>
            
           {rowData.userVerified ? "Verified" : "Not Verified"}
          </p>
        ),
      },
    ]}
