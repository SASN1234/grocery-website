...

{
  ...
  <motion.div  {...slideTop} transition={{ delay:2, duration:1}} className="bg-yellow-200 rounded-t-[60px] w-full h-[45%] flex flex-col items-center justify-center pb-20 cursor-pointer px-4 py-3 gap-8">
          ...
          <motion.div onClick={payment} {...buttonClick} className="bg-green-400 w-[60%] px-2 py-3 text-xl text-headingColor font-semibold hover:bg-green-500 text-center drop-shadow-md rounded-2xl" >
             PAY
          </motion.div>
